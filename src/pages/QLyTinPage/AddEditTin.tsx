            ...
            <div className="mx-auto p-6 bg-white rounded shadow mt-24 min-h-screen mb-16">
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center flex-grow text-center mt-24 mb-16">
                        <CircularProgress />
                        <p className="mt-4 text-gray-600 text-2xl">Đang tải nội dung...</p>
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col" encType="multipart/form-data">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button
                                ...
                                style={{
                                    backgroundColor: isSubmitted ? '#60a5fa' : '#1d4ed8', // #60a5fa là màu nhạt hơn, #1d4ed8 là màu chính
                            ...
                            >
                                {!isSubmitted
                                    ...
                                    : (id_tin ? 'Đang cập nhật...' : 'Đang thêm mới...')}
                            </button>
                        </div>
                    </form>
                )}
